...
export default function WorksPage() {
  ...
  return (
    <div className="relative h-[calc(100vh-160px)] flex items-center overflow-hidden -mt-8">
      {/* ─ Works list ─ */}
      <div className="w-full">
        <WorksList works={works} />
      </div>

      {/* ─ SNS Icons (High Quality/Solid) ─ */}
      <div className="absolute bottom-0 right-0 flex gap-6 z-50 mb-8 mr-4 md:mr-0">
